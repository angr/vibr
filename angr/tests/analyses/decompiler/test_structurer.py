...
class TestStructurer(unittest.TestCase):
    ...
    def test_phoenix_switch_cases_address_loaded_from_memory_node_a_being_region_head(self):
        ...
        # One unoccupied exception-directory start is consumed when hints are enabled. Keep this assertion compatible
        # with older CLE versions that still classify native PE unwind records as EH_FRAME so angr can land first.
