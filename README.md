...
<!-- vibr:begin -->
Generated 2026-08-26T22:31:57+00:00 from a selection made 2026-08-26T22:31:57+00:00.

| Component | Base | Applied | Skipped | Excluded |
| --- | --- | ---: | ---: | ---: |
| [angr](https://github.com/angr/angr) | [4f6489858d](https://github.com/angr/angr/commit/4f6489858d81856cd7d0f1f6f034b59f52fabaa7) | 74 (23 resolved) | 10 | 20 |
...
| [cle](https://github.com/angr/cle) | [46a37333f4](https://github.com/angr/cle/commit/46a37333f4f59b0facf8774ee743ebc4cc074e9b) | 38 (9 resolved) | 8 | 6 |
...
- [#6808](https://github.com/angr/angr/pull/6808) SpillingCFG: Index the nodes that an edge inserts into the graph -- resolved: union merge of tests: tests/analyses/cfg/test_cfgfast.py
...
- [#6853](https://github.com/angr/angr/pull/6853) Decompiler: Preserve virtual-variable bindings across index collisions -- resolved: union merge of tests: tests/analyses/decompiler/test_dephication_rewriting.py
...
- [#6963](https://github.com/angr/angr/pull/6963) Decompiler: rebuild duplication reverter jump targets
...
- [#6964](https://github.com/angr/angr/pull/6964) SimType: check the alignment sentinel before converting it to bits -- checks not green: ci / Typecheck concluded FAILURE
- [#6970](https://github.com/angr/angr/pull/6970) ReturnMaker: report a return register the architecture does not have -- checks not green: ci / Typecheck concluded FAILURE
- [#6972](https://github.com/angr/angr/pull/6972) RegionIdentifier: take the function entry as the region start node -- checks not green: ci / Typecheck concluded FAILURE
- [#6973](https://github.com/angr/angr/pull/6973) StructurerBase: do not cut a block where a temporary crosses the cut -- checks not green: ci / Typecheck concluded FAILURE
...
Applied:
- [#704](https://github.com/angr/cle/pull/704) Test CLE under Pyodide
...
- [#721](https://github.com/angr/cle/pull/721) Pack and unpack words struct cannot describe -- resolved: union merge of tests: tests/test_clemory.py
...
- [#732](https://github.com/angr/cle/pull/732) Stop indexing PE and ELF header tables past their declared length -- resolved: union merge of tests: tests/test_pe.py
...
- [#757](https://github.com/angr/cle/pull/757) PE: Resolve the machine type of a ReadyToRun image built for another system -- resolved: union merge of tests: tests/test_pe.py
